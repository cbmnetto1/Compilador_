...
public class glcParser extends Parser {
	...
	public static class BlocoContext extends ParserRuleContext {
		...
		public List<EstruturaControleContext> estruturaControle() {
			return getRuleContexts(EstruturaControleContext.class);
		}
		public EstruturaControleContext estruturaControle(int i) {
			return getRuleContext(EstruturaControleContext.class,i);
		}
	...
	public final BlocoContext bloco() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (((((_la - 3)) & ~0x3f) == 0 && ((1L << (_la - 3)) & 4553421802004545599L) != 0)) {
				{
				setState(117);
				_errHandler.sync(this);
				switch (_input.LA(1)) {
